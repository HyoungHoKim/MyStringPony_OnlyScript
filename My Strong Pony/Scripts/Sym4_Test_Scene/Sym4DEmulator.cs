...
namespace Sym4D
{
    public unsafe class Sym4DEmulator : MonoBehaviour
    {
        ...
        // Sym4D-X100 장비가 연결되어 있는 Serial Port를 찾는 함수		리턴값의 정의  예) 25 -> 장비가 연결된 Serial Port = COM25 
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_X_Find();




        // Sym4D-W100 장비가 연결되어 있는 Serial Port를 찾는 함수		리턴값의 정의  예) 25 -> 장비가 연결된 Serial Port = COM25 
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_W_Find();




        // Sym4D-X100 장비가 연결되어 있는 Serial Port를 찾는 함수		리턴값의 정의  예) 2 -> 연결된 장비의 개수 2개 
        // *aPortData 리턴값의 정의  예) 장비가 연결된 Serial Port의 배열 1Byte당 포트 번호 1개
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_X_Multi_Find(Byte* aPortData);




        // Sym4D-W100 장비가 연결되어 있는 Serial Port를 찾는 함수		리턴값의 정의  예) 2 -> 연결된 장비의 개수 2개 
        // *aPortData 리턴값의 정의  예) 장비가 연결된 Serial Port의 배열 1Byte당 포트 번호 1개
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_W_Multi_Find(Byte* aPortData);




        // Sym4D-X100 장치의 포지션을 중심으로 이동
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_Init();




        // Sym4D-W100 장치의 풍량을 0로 초기화
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_W_Init();




        // Sym4D-X100 장치의 최대 허용 각도를 설정  : mRoll, mPitch의 범위 = 0 ~ 100 (0도 ~ 10도)
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_SetConfig(int mRoll, int mPitch);




        // Sym4D-W100 장치의 최대 풍량 설정  : mWind 범위 = 0 ~ 100 (0% ~ 100%)
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_W_SetConfig(int mWind);




        // Sym4D-X100 장치에 모션 Data를 전달  : mRoll, mPitch의 범위 = -100 ~ 100 (-10도 ~ 10도)
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_SendMosionData(int mRoll, int mPitch);




        // Sym4D-W100 장치에 바람 Data를 전달  : mWind의 범위 = -100 ~ 100 (-100% ~ 100%)
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_W_SendMosionData(int mWind);




        // Sym4D-X100 COM Port Open  및 컨텐츠 시작을 장치에 전달		sComPortName 인자의 예) COM5 -> 5, COM17 -> 17
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_StartContents(int sComPortName);




        // Sym4D-W100 COM Port Open  및 컨텐츠 시작을 장치에 전달		sComPortName 인자의 예) COM5 -> 5, COM17 -> 17
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_W_StartContents(int sComPortName);




        // Sym4D-X100 COM Port Close 및 컨텐츠 종료를 장치에 전달
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_EndContents();



        // Sym4D-W100 COM Port Close 및 컨텐츠 종료를 장치에 전달
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_W_EndContents();




        // Dll API 모듈의 버전 정보			리턴값의 정의  예) 1000 = Ver 1.00.0      10000 = Ver 10.00.0
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_API_Version();




        // Sym4D-X100 누적 동작 카운트 정보
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int Sym4D_TotalCounter();
        ...
        // Sym4D-X Board Reset
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_Reset();




        // Sym4D-X 장치에 모션 Data를 전달  : mRoll, mPitch의 범위 = -100 ~ 100 (-10도 ~ 10도), mSpeed의 범위  = 0 ~ 100
        [DllImport(Sym4D_Dll, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool Sym4D_X_SendMosionData2(int mRoll, int mPitch, int mSpeed);   




        // 메디치 장치에서는 사용하지 못하는 기능들
        /****************************************************************************************/
        /*                                 New Type Board Only                                  */
        /****************************************************************************************/
